...
[![Security Status](https://www.murphysec.com/platform3/v31/badge/1695504809745801216.svg)](https://www.murphysec.com/console/report/1692243725974917120/1695504809745801216)
...
| star：10528 | watch：232 | fork：3416 |
| ----------- | -------------- | ------------ |
| 所有者：Organization | 更新时间：2023-08-27 00:55:18 | 许可证：Apache-2.0 |
| 最近检测时间：2023-08-27 02:42:33 | 组件总数：1943 | 漏洞总数：26 |
...
|@aws-sdk/client-account|3.395.0|直接依赖|npm|
...
|jest-resolve-dependencies|29.6.3|间接依赖|npm|
...
|@aws-sdk/client-sfn|3.395.0|直接依赖|npm|
...
|@aws-sdk/client-cognito-identity|3.397.0|间接依赖|npm|
|before-after-hook|2.2.3|间接依赖|npm|
|@jest/globals|29.6.3|间接依赖|npm|
|is-lambda|1.0.1|间接依赖|npm|
|@aws-sdk/util-locate-window|3.310.0|间接依赖|npm|
|array-union|2.1.0|间接依赖|npm|
|filing-cabinet|3.3.1|间接依赖|npm|
|map-obj|1.0.1|间接依赖|npm|
|@aws-sdk/credential-provider-cognito-identity|3.397.0|间接依赖|npm|
...
|d|1.0.1|间接依赖|npm|
|@aws-sdk/middleware-endpoint-discovery|3.391.0|间接依赖|npm|
|@aws-sdk/client-sts|3.395.0|直接依赖|npm|
|@jridgewell/gen-mapping|0.3.3|间接依赖|npm|
|type-fest|2.19.0|间接依赖|npm|
|proc-log|2.0.1|间接依赖|npm|
|inquirer|8.2.6|间接依赖|npm|
|safe-json-stringify|1.2.0|间接依赖|npm|
|constructs|10.2.69|直接依赖|npm|
|tslib|1.14.1|间接依赖|npm|
|co|4.6.0|间接依赖|npm|
|@aws-sdk/types|3.391.0|直接依赖|npm|
|@nx/nx-linux-arm64-gnu|16.7.3|直接依赖|npm|
...
|typescript|5.3.0-dev.20230823|间接依赖|npm|
...
|@aws-sdk/client-codepipeline|3.395.0|直接依赖|npm|
...
|@aws-sdk/client-lambda|3.395.0|直接依赖|npm|
...
|@aws-sdk/client-amplify|3.395.0|直接依赖|npm|
...
|@jest/test-result|29.6.3|间接依赖|npm|
...
|@jest/expect|29.6.3|间接依赖|npm|
|glob|10.3.3|间接依赖|npm|
|@aws-sdk/client-secrets-manager|3.395.0|直接依赖|npm|
...
|@aws-sdk/client-iam|3.395.0|直接依赖|npm|
...
|@aws-sdk/middleware-sdk-route53|3.391.0|间接依赖|npm|
...
|tr46|0.0.3|间接依赖|npm|
|@aws-sdk/middleware-sdk-ec2|3.391.0|间接依赖|npm|
|check_call||间接依赖|pip|
...
|@nx/nx-win32-x64-msvc|16.7.3|直接依赖|npm|
...
|@nx/nx-freebsd-x64|16.7.3|直接依赖|npm|
|pac-proxy-agent|7.0.0|间接依赖|npm|
|ora|5.4.1|间接依赖|npm|
|jest-matcher-utils|29.6.3|间接依赖|npm|
...
|@aws-sdk/client-s3|3.397.0|直接依赖|npm|
