# ciaochaos/qrbtf安全风险及SBOM

## 基础信息

项目徽章：

[![Security Status](https://www.murphysec.com/platform3/v31/badge/1692607043636846592.svg)](https://www.murphysec.com/console/report/1671059209729105920/1692607043636846592)

仓库描述：An art QR code (qrcode) beautifier.  艺术二维码生成器。https://qrbtf.com

仓库地址：[https://github.com/ciaochaos/qrbtf](https://github.com/ciaochaos/qrbtf)

| star：5258 | watch：52 | fork：418 |
| ----------- | -------------- | ------------ |
| 所有者：User | 更新时间：2023-08-16 23:30:08 | 许可证：GPL-3.0 |
| 最近检测时间：2023-08-19 02:39:14 | 组件总数：1416 | 漏洞总数：66 |
...
|@typescript-eslint/eslint-plugin|2.30.0|间接依赖|npm|
...
|react-indiana-drag-scroll|1.6.1|直接依赖|npm|
...
|github-buttons|2.11.0|间接依赖|npm|
...
|cloudbase-adapter-wx_mp|0.1.1|间接依赖|npm|
...
|react-github-btn|1.2.0|直接依赖|npm|
|svgo|1.3.2|间接依赖|npm|
...
|@cloudbase/adapter-interface|0.4.0|间接依赖|npm|
|@cloudbase/database|0.9.11-rc.0|间接依赖|npm|
