...
|org.jboss.logging:jboss-logging-processor|2.1.0.Final|间接依赖|maven|
...
|org.springframework.security:spring-security-rsa|1.0.5.RELEASE|间接依赖|maven|
...
|com.alibaba:fastjson|1.2.60|间接依赖|maven|
...
|io.netty:netty-resolver-dns|4.1.42.Final|间接依赖|maven|
...
|io.smallrye.reactive:mutiny|0.4.3|间接依赖|maven|
...
|com.alibaba:fastjson|1.2.29|间接依赖|maven|
...
|junit:junit|4.13-beta-2|间接依赖|maven|
...
|org.springframework.security:spring-security-crypto|5.0.6.RELEASE|间接依赖|maven|
...
|io.netty:netty-codec-http2||间接依赖|maven|
...
|io.netty:netty-codec-dns|4.1.42.Final|间接依赖|maven|
